...
htmltools::HTML(
  glue::glue(
    "<h4>RSVP and join our {get_n_members(format = TRUE)}members on the <a href='https://www.meetup.com/nyhackr/?utm_source=nyhackr' target = '_blank'>New York Open Statistical Programming Meetup <i class='fa fa-meetup'></i></a></h4>"
  )
)
```
