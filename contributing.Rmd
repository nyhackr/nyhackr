...
The nyhackr website was built as a [RMarkdown website](http://rmarkdown.rstudio.com/rmarkdown_websites.html) and the source code can accessed by the community on [GitHub](https://github.com/nyhackr/nyhackr). If you wish to contribute to the website the process is pretty simple.
